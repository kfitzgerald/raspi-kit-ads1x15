...
module.exports = function(program) {
    ...
    program
        ...
        .description('Reads the difference between two channels continuously.')
        .action(function(chip, options) {
            ...
            raspi.init(() => {
                ...
                adc.startContinuousDifferential(differential.value, (err, value, volts) => {
                    if (err) {
